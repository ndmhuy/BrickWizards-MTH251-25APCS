...
\begin{enumerate}[label = (\alph*)]
    ...
    \item \textbf{Construction and expression of $\mathbf{R_n}$}
    \begin{itemize}
    ...
    \item \textbf{Rewriting $\mathbf{R_n}$} \\
    ...
    \item \textbf{Limit computation and verification:}
    \begin{itemize} 
    ...
    \item \textbf{Interpretation and Parameter Dependence:}
