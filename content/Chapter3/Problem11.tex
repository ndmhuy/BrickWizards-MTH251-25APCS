...
\textbf{(a) Construction and expression of $\mathbf{R_n}$}
    ...
    \begin{split}
        ...
        &= \sum_{i=1}^n \left[\left(\frac{ia}{n}\right)^2 + 2\frac{ia}{n}\right]\frac{a}{n} \\
        &= \sum_{i=1}^n \left(\frac{i^{2}a^{3} + 2ia^{2}n}{n^3}\right)
    \end{split}
    \end{equation*}
    Hence,
    \begin{center} \fbox{$\displaystyle R_n = \sum_{i=1}^n \left(\frac{i^{2}a^{3} + 2ia^{2}n}{n^3}\right)$} \end{center}
    \end{itemize}
...
\textbf{(b) Rewriting $\mathbf{R_n}$} \\
    ...
    Let \[S = \sum_{i=1}^n \left(\frac{i^{2}a}{n} + 2i\right)\] 
    \begin{equation}
    \Longrightarrow R_n = \frac{a^2}{n^2}\cdot S
    \end{equation}
    We calculate $S$:
    \begin{align*}
        S &= \sum_{i=1}^n \left(\frac{i^{2}a}{n} + 2i\right) \\
...
\textbf{(c) Limit computation and verification:}
    ...
    \begin{align*}
        \lim_{n\to \infty} R_n &= \lim_{n\to \infty} \left[\frac{a^3 (n+1)(2n+1)}{6n^2} + \frac{a^2 (n+1)}{n} \right] \\
        &= \lim_{n\to \infty} \left[\frac{a^3 (n+1)(2n+1) + a^2 6n(n+1)}{6n^2} \right] \\
        &= \lim_{n\to \infty} \left[\frac{(2a^3 + 6a^2)n^2 + (3a^3 + 6a^2)n + a^3}{6n^2} \right] \\
        &= \lim_{n\to \infty} \left[\frac{(2a^3 + 6a^2) + \frac{3a^3 + 6a^2}{n} + \frac{a^3}{n^2}}{6} \right] \\
        \intertext{Using the limit property $\displaystyle\lim_{n \to \infty} \frac{c}{n^k} = 0$ for $k > 0$, we get: } 
        \lim_{n\to \infty} R_n &= \lim_{n\to \infty} \left[\frac{(2a^3 + 6a^2) + 0 + 0}{6} \right] \\
        &= \lim_{n\to \infty} \left(\frac{a^3}{3} + a^2\right) \\
        &= \frac{a^3}{3} + a^2 
    \end{align*}
    Thus, \begin{equation}
    ...
    \begin{align*}
        ...
        &= \left. \left(\frac{x^3}{3} + x^2\right) \right|_{x=0}^{x=a}
    \end{align*}
    \begin{equation}
...
\textbf{(d) Interpretation and Parameter Dependence:}
    The final expression $A(a) = \dfrac{a^3}{3} + a^2$ represents the \textbf{exact area} under the curve $f(x)=x^2+2x$ from $x=0$ to $x=a$.
